...
export function MenuNavigation() {
    ...
    return (
        <div className="fixed bottom-0 left-1/2 flex h-menuNavigation w-full max-w-[1024px] z-50 -translate-x-1/2 items-center justify-between bg-secondary px-pageX">
